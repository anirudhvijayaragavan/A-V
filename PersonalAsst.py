...
class MA(Tk):
    ...
    while n < 100:
        ...
        def __init__(self):
            ...
            self.btn1 = Button(self, text='click to speak', command=self.trait)
            self.btn1.place(x=205, y=250)
            label1=Label(self,text="Bot Assistant",relief='solid',width=22,font=("arial",23,"bold"))
...
# Speech recognition using Google Speech Recognition
    ...
    # instead of `r.recognize_google(audio)`
            ...
            threading.Thread(target=real_trait).start()
        n = n+1
